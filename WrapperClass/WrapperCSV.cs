...
namespace WrapperUnion
{
    ...
    public class WrapperTextFile
    {
        ...
        {
            if (this.IsValidIndex(nIndex) == false) return string.Empty;
            string temp = m_list.ElementAt(nIndex);
            return temp;
        }
        public List<string> GetAll()
        {
        ...
        public void SaveTextFile(string strPath, List<string> list)
        {
            RemoveAll();
